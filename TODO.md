...
Добавить методы для работы с прогрессом слов: смена статуса, вычесление следующей даты изучения. 10 градаций для прогресса
Добавить/проверить метод для формирования списка изучаемых карточек. Пока просто выбираются все по дате
Добвить/проверить метод для изменения позиции карточки в списке текущего урока в зависимости от ответа
Поправить фрагмент прямого перевода. Две стороны у карточки, кнопки для оченки знания, изображение
Добавить фрагмент обратного перевода
Добавить фрагмент ввода слова
Добавить таблицу истории ответов
Добавить таблицу настроки условий перехода между типами карточек
