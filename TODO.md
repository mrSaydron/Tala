...
Разделить хранение слов, прогресс, задания и коллекции
Добавить режимы обучения, вернуть изучение предложениями

### В активной работе:

Словарь создание:
- Просмотр слов работает очень долго, надо поправить. Как понимаю происходят множественные запросы в БД на обновление
- Собрать теги в один блок, с выпадающим списком
- Добавить возможность добавлять изображение
