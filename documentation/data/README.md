...
| Связанные документы | [ER-диаграмма](./er_diagram.mermaid), [Прогресс карточек](../cards/card_progress.md) |
...
- Актуальная ER-диаграмма хранится в формате Mermaid: [er_diagram.mermaid](./er_diagram.mermaid). Рендеринг доступен в IDE или на GitHub.
