...
В редактировании слова смешались значки группы и слова. Надо их разделить. Справа от группы добавить иконку с тремя кнопками и выпадающим меню для добавления и удаления. Для слова нажи группы добавить кнопки сохранения, удаления, и шестеренку
